...
service MessageService {
  ...
  list<bool> getUserOnlineStatus(1: UserIdCollection userIdCollection)
  void sendMessageWithOneOfflineMessage(1: UserIdCollection userIdCollection, 2:string type, 3: Message message)
}